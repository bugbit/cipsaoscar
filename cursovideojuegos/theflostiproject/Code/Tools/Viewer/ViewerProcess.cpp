...
void CViewerProcess::RenderScene (CRenderManager* renderManager, CFontManager* fm)
{
...
uint32 CViewerProcess::RenderDebugInfo(CRenderManager* renderManager, CFontManager* fm, float fps)
{
	uint32 posY = 0;
...
void CViewerProcess::UpdateInputActions	(CInputManager* inputManager)
{
...
//-----------------ScriptManager------------------------------
void CViewerProcess::RegisterFunctions (CScriptManager* scriptManager)
{
	...
	module(l_pLUAState)
    [
		def("getViewer", GetViewer),
		
		// registramos la clase CViewerProcess
		class_<CViewerProcess>(CScriptRegister::SetClassName("CViewerProcess"))
