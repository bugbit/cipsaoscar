...
int APIENTRY WinMain(HINSTANCE _hInstance, HINSTANCE _hPrevInstance, LPSTR _lpCmdLine, int _nCmdShow)
{
	...
	try
	{
		CAirHockeyGameProcess* airHockeyGame = new CAirHockeyGameProcess("AirHockeyGame");
		std::vector<CProcess*> l_ProcessVector;
		l_ProcessVector.push_back(airHockeyGame);
		g_FlostEngine->LoadInitParams("Data/Config/init_airHockey.xml");
