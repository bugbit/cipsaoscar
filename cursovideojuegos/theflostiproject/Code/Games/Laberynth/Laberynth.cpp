...
#define APPLICATION_NAME	"LABERYTNH GAME"
...
int APIENTRY WinMain(HINSTANCE _hInstance, HINSTANCE _hPrevInstance, LPSTR _lpCmdLine, int _nCmdShow)
{
	...
	try
	{
		CLaberynthProcess * l_LaberynthGame = new CLaberynthProcess("LaberynthGame");
		std::vector<CProcess*> l_ProcessVector;
		l_ProcessVector.push_back(l_LaberynthGame);
		g_FlostEngine->LoadInitParams("Data/Config/init_laberynth.xml");
