========================================================================
    APLICACIÓN DE WIN32: Quake Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación Quake.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la Quake aplicación.
...
small.ico
    ...
    de recursos principal Quake.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Quake.pch y un archivo de 
