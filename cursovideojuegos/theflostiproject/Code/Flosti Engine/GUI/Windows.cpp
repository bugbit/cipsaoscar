...
void CWindows::Render (CRenderManager *renderManager, CFontManager* fm)
{
	std::vector<CGuiElement*>::iterator it(m_GuiElementsVector.begin());
	std::vector<CGuiElement*>::iterator itEnd(m_GuiElementsVector.end());
...
void CWindows::LoadButton (CButton* button, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void CWindows::LoadCheckButton (CCheckButton* checkButton, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void CWindows::LoadSlider (CSlider* slider, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::LoadDialogBox			(CDialogBox* dialogBox, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::LoadEditableTextBox (CEditableTextBox* editableTextBox, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::LoadRadioBox(CRadioBox* radioBox, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::_LoadImage(CImage* image, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::LoadProgressBar(CProgressBar* progressBar, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
...
void	CWindows::LoadStaticText(CStaticText* staticText, CXMLTreeNode& pNewNode, const Vect2i& screenResolution, CTextureManager* tm)
{
