...
//http://www.borelly.net/cb/Docs/libxml/examples/index.html
  ...
  if (NewXML.StartNewFile("test.xml"))
  {
    ...
    NewXML.StartElement("Companies");
      NewXML.StartElement("Company");
        NewXML.WritePszProperty("name", "GRIN");
        ...
        NewXML.StartElement("Workers");
          ...
          NewXML.StartElement("worker");
            ...
            NewXML.WriteFloatProperty("salary", 232.4);
          ...
          NewXML.StartElement("worker");
            ...
            NewXML.WriteFloatProperty("salary", 122.3214);
