...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/3enraya

dist/Debug/GNU-Linux-x86/3enraya: ${OBJECTFILES}
...
${OBJECTDIR}/CIAPlayer.o: nbproject/Makefile-${CND_CONF}.mk CIAPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CIAPlayer.o CIAPlayer.cpp

${OBJECTDIR}/CLocalHumanPlayer.o: nbproject/Makefile-${CND_CONF}.mk CLocalHumanPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CLocalHumanPlayer.o CLocalHumanPlayer.cpp
...
${OBJECTDIR}/casciiboardrender.o: nbproject/Makefile-${CND_CONF}.mk casciiboardrender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/casciiboardrender.o casciiboardrender.cpp
...
${OBJECTDIR}/cboardrender.o: nbproject/Makefile-${CND_CONF}.mk cboardrender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/cboardrender.o cboardrender.cpp
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/3enraya
