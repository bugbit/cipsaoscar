...
#define APPLICATION_NAME	"QUIZ GAME"
...
int APIENTRY WinMain(HINSTANCE _hInstance, HINSTANCE _hPrevInstance, LPSTR _lpCmdLine, int _nCmdShow)
{
	...
	try
	{
		CQuizProcess* quizGame = new CQuizProcess("QuizGame");
		std::vector<CProcess*> l_ProcessVector;
		l_ProcessVector.push_back(quizGame);
		g_FlostEngine->LoadInitParams("Data/Config/init_quiz.xml");
